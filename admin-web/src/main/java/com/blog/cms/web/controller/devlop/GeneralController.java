...
public class GeneralController {
    ...
    public JsonResult create(HttpServletRequest request)
    {
        ...
        String domainName=tableName.split("_")[1];
        try {
            ...
            String mapperPath=path+"/admin-application/src/main/resources"+xmlPath;
            CreateBean.create(domainName, domainPackageName, domainPath, list);
